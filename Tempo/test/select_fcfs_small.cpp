...
int main()
{
        Tempo::job_generator gen(0.01, 5, 5, 2, 80, 30, 0.7, 0.6, 1);
        gen.seed(time(NULL));
        Tempo::job j1 = gen();

        Tempo::job_generator gen1(0.1, 6, 3, 80, 30, 0.2, 0.5, 1, 1);
	...
	pools.push_back(Tempo::pool("modeling", 2, 200, 1, 10, 10, Tempo::pool::SCHED_FCFS));
